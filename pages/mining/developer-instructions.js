    ...
    return (
      <Page>
        ...
        <Section mx="auto" my={5} width={[1, 0.6]}>
          ...
          <Content>
            <Type.p>
              Complete all of the following steps to register your app for App Mining and start receiving rewards.
            </Type.p>
            <Ol>
              <Li>
                <Type.p mt={0}>
                  <a href="https://blockstack.org/tutorials/todo-list/">Integrate Blockstack Auth into your app</a>
                </Type.p>
              </Li>
              <Li>
                <Type.p mt={0}>
