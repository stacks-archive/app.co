...
const Steps = ({ ...rest }) => (
  <Flex justifyContent={['center', 'center', 'space-between']} flexWrap="wrap" {...rest}>
    {sections.map(({ graphic: Graphic, eventLabel, button: { label, ...buttonProps }, text }) => (
      <Flex pt={7} alignItems="center" justifyContent="center" key={eventLabel} flexDirection="column">
        {Graphic ? (
          <Box width="180px">
            <Graphic />
          </Box>
