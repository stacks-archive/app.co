  ...
  render() {
    ...
    return (
      <Cards.GrayCard>
        ...
        <br />
        <p>
          Hello developer! We'd love to see your hard work listed here. Click below to submit your decentralized
          application.
        </p>
        ...
        <SubmitDappModal open={this.state.modalOpen} close={() => this.setState({ modalOpen: false })} />
      </Cards.GrayCard>
    );
  }
}
