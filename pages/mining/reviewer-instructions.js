...
const ReviewerInstructions = () => (
  <Page>
    ...
    <Section mx="auto" my={5} width={[1, 0.6]}>
      ...
      <Content>
        <Type.p>
          Reviewers submit their app rankings to Blockstack every month. The first day of the month Blockstack will email reviewers a spreadsheet in which to record rankings.
        </Type.p>
        <Type.p>
          To submit app rankings, complete the following steps:
        </Type.p>
        <Ol>
          <Li>
            <Type.p>
              Download spreadsheet for the month
            </Type.p>
            <Type.p>
          ...
          <Li>
            <Type.p>
              Record your rankings in the spreadsheet
            </Type.p>
            <Type.p>
              Place a rank value in the Ranking column next to each app you would like to rank. You can rank only those apps you want and omit ranking others. Rank each application numerically where 1 (one) is the highest.
            </Type.p>
            <Type.p>
